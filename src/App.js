      ...
      <BrowserRouter>
        ...
        <Switch>
          ...
          <Route
            ...
            path="/savedMemories"
            component={() =>
              !ctx.user ? <Redirect to="/posts" /> : <SavedMemories />
            }
          />
          <Route
            exact
            path="/myMemories"
            component={() =>
              !ctx.user ? <Redirect to="/posts" /> : <UserMemories />
            }
          />
          <Route
            exact
            path="/user/:signin"
            component={() => (ctx.user ? <Redirect to="/posts" /> : <Auth />)}
          />
          <Route
            exact
            path="/user/resetPassword/:token"
            component={() =>
              ctx.user ? <Redirect to="/posts" /> : <ResetPassword />
            }
          />
